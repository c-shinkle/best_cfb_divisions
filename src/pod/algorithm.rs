...
// use super::combo::get_all_combinations_two_play_opponents;
// use crate::distance_lookup_table::create_lookup_table;
// use crate::pod::distance::PodDistance;
use crate::types::*;

pub fn find_best_two_play_opponents(_: &Conference) {
    // assert!(
    //     conference.len() / POD_COUNT == 4,
    //     "Conference length divided by Pod coutn must equal 4!"
    // );
    // let all_pod_quadruples = get_all_combinations_two_play_opponents::<POD_COUNT>(conference);
